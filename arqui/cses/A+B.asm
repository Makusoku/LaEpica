...
_start: 
    ...
    ; Calculo de la suma (la suma se guarda en rcx)

    ; Esto puede ser obviado (Es solo para explicar lodsb)
        mov     rsi,    buff        ; Ubicamos el inicio de la cadena en rsi
        lodsb                       ; Carga 1 byte de rsi a al, rsi aumenta en uno
    ;
    ...
    mov     rcx,    rdx             
    call    atoi
    add     rcx,    rdx             ; La suma esta en rcx, rsi esta en el final de la cadena
